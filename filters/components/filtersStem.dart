...
class FiltersStem extends StatefulWidget {
  @override
  _FiltersStem createState() => _FiltersStem();

  static const routeName = "/FiltersStem";
}

class _FiltersStem extends State<FiltersStem> with TickerProviderStateMixin {
  ...
  FilterDropdown typeDd = new FilterDropdown(hint: "Typ", options: Stem.type);
                  ...
                  children: [
                    Positioned(
                        ...
                        child: CircularButton(
                          ...
                          args.args.filters.params["stemType"] =
