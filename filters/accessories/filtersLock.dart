...
class FiltersLock extends StatefulWidget {
  @override
  _FiltersLock createState() => _FiltersLock();

  static const routeName = "/FiltersLock";
}

class _FiltersLock extends State<FiltersLock> with TickerProviderStateMixin {
  ...
  FilterDropdown typeDd = new FilterDropdown(hint: "Typ", options: Lock.type);
                  ...
                  children: [
                    Positioned(
                        ...
                        child: CircularButton(
                          ...
                          args.args.filters.params["lockType"] =
